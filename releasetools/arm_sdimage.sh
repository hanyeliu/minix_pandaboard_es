...
: ${CROSS_PREFIX=${CROSS_TOOLS}/arm-none-linux-gnueabi-}
: ${JOBS=1}
...
mcopy -bsp -i ${IMG_DIR}/fat.img /home/junzhe/git/u-boot-linaro-stable/$MLO ::MLO
mcopy -bsp -i ${IMG_DIR}/fat.img /home/junzhe/git/u-boot-linaro-stable/$UBOOT ::u-boot.img
